  ...
  <div id="carouselExampleCaptions" class="carousel slide col-md-12" data-bs-ride="carousel">
    ...
    <div class="carousel-inner">
      ...
      if (pg_num_rows($run_query) > 0) {
        ...
        <img src="slider/'.$img_slider.'" class="d-block w-100" alt="..." height="480">
     ...
     // CONSULTA PARA TRAER EL RESTO DE LOS SLIDER CON LA CONDICION DE QUE EL ID_SLIDER SEA DIFERENTE AL ID_SLIDER DE LA CONSULTA ANTERIOR DONDE MOSTRAMOS EL SLIDER ACTIVO
...
<div class="container card"> <!-- DIV SESION ULTIMAS NOTICIAS -->
  <div class="row">
    ...
    $query = "SELECT * FROM posts WHERE status='Publicado' ORDER BY id DESC LIMIT 2";
    $run_query = pg_query($conn, $query);
    if (pg_num_rows($run_query) > 0) {
