...
else if ($_POST['password'] !== $_POST['cpassword']) 
{
	...
	include ('register.php');
      ...
      $run_check = pg_query($conn , $checkusername);
      $count = pg_num_rows($run_check); 
      if ($count > 0 ) {
	  echo  "<center><font color='red'>Nombre de usuario ya tomado! prueba uno diferente</font></center>";
	  include ('register.php');
	  exit();
}
